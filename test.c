...
void test_prompt_encoding_2(Tokenizer* tokenizer) {
...
void test_prompt_encoding_3(Tokenizer* tokenizer) {
...
void test_prompt_encoding_4(Tokenizer* tokenizer) {
...
void test_prompt_encodings() {
    ...
    test_prompt_encoding_0(&tokenizer);
    test_prompt_encoding_1(&tokenizer);
    test_prompt_encoding_2(&tokenizer);
    test_prompt_encoding_3(&tokenizer);
    test_prompt_encoding_4(&tokenizer);
